...
function win_decode_luck_data(subjects)
    delete(gcp('nocreate'))
    parpool;
    eeglab;
...
% parameters to set
    ...
    dataLocation = strcat("G:/My Drive/MudrikLab020818/Experiments_new/Jonathan/"); % set directory of data set
    ...
    for subjectIdx = 1:numel(subjects)
        ...
        for condition = conditions
            subjectEEGs.allConditions{condition}.nTrialsPerAveragedTrial = floor(minTrialnum\nAveragedTrials);
